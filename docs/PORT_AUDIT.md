...
| Tasks                    | Versioned task save state, task clock/journal, volunteer work, visit/find/kill generation, stone delivery, nine-altar start/reward progression, deadlines and Gu Yanwu rewards are formula-tested and wired to maps/NPCs | Partial: wanted, hidden and sect task runtimes remain                                     |
