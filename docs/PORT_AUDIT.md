...
| Tasks                    | Versioned task save state, task clock/journal, volunteer work, visit/find/kill generation, completion deadlines and Gu Yanwu rewards are formula-tested and wired to maps/NPCs                  | Partial: wanted, stone, hidden, sect and altar progression runtimes remain               |
