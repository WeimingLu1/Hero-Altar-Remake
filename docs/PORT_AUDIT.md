...
| Tasks                    | Versioned task save state, task clock/journal, volunteer work, visit/find/kill generation, dynamic wanted criminals, stone delivery, nine-altar progression, deadlines and rewards are formula-tested and wired to maps/NPCs | Partial: hidden and sect task runtimes remain                                             |
