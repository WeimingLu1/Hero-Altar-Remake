...
> Updated 2026-08-16. This audit covers deterministic RMXP parity; the newer
...
| Save files               | Versioned local JSON import/export, normalization and editable actor/world/task/forge/home/minigame fields; unavailable, corrupt and quota failure modes are distinguished without deleting damaged source data                            | Implemented |
| Keyboard                 | Mac/Windows-compatible WASD/arrows, E/Enter, X/Escape, C/M, 1–4, R/H/T/Q/I/G and every modal have keyboard and clickable controls; Z, Space, F, F1–F12 and K are intentionally unbound                                                      | Implemented |
