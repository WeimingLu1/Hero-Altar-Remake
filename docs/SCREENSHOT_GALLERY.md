...
本页使用 Web 版本的高清完整页面截图，集中展示地图探索、人物资料、门派成长、任务、环境会话和战斗系统；截至 2026-08-28 的 Sites v113，NPC 主动交谈已重构为地图底部双立绘的统一交谈界面，旧版自由对话截图仅作历史视觉记录，不再作为当前设计参考。
...
环境交谈现在只允许一对一，并按“一人一句、当前句消失后另一人再开口”的顺序显示；气泡优先位于说话人头顶，冲突时依次避让到左右、脚下和邻近空位。主角气泡使用蓝色强调并保持最高绘制层。对话以陈述、回答和补充为主，仅偶尔自然提问；自言自语和动作继续作为独立气泡显示。图库中的旧画面只作地图与人物氛围参考，不代表现行气泡时序。
