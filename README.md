...
标题页的“模型设置”可以修改服务地址、模型名和请求超时，并即时检测连接状态；配置只保存在当前浏览器。
...
当前版本通过243项逻辑/视觉测试和3项服务端渲染测试，共246项，0失败；同时通过类型检查、ESLint、生产构建与体积预算。项目仍在积极开发中，接口、存档结构和美术资源可能继续调整。
