...
战斗系统包含切磋、生死战与剧情战，支持普通攻击、武器匹配、招架、主动绝招、法术链、冷却、战斗物品、逃跑、战利品和道德/任务结算；战斗双方使用统一人物立绘，战斗过程保留完整事实记录并可由本地模型生成精简武侠叙事。静态NPC按真实战斗武学分层强化气血、内法力、四维与命中，高手还能从自身武功中选择可支付的攻击型绝招；没有武功的百姓保持原始弱小数值。
...
- NPC武境分层强化、高手命中成长与主动绝招，以及高资源递减收益的法术和持续燃烧公式。
...
当前版本通过164项逻辑/视觉测试和3项服务端渲染测试，共167项，0失败。项目仍在积极开发中，接口、存档结构和美术资源可能继续调整。
