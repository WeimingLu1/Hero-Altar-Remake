...
网页版本保留原作69张地图及转场关系，同时重新组织道路、院落、围栏、植被和多格建筑。所有可互动NPC、门、设施和物品都会常驻高亮并显示名称，玩家可以在平安镇、商业街、各大门派、洞府与险地之间探索；地图事件继续负责交易、任务、拜师、战斗和场景转移。
...
地图视觉优先使用成熟的32×32 LPC开源图集，并保留原始作者、来源和
许可证文件。室外按地域使用草地、泥土、沙地、水面与雪地，透明树木
花草叠加在一致的地面上；室内默认木地板，门派室外默认石材院坪。
已接入的第三方素材清单位于 `public/game-assets/open-source/`。
