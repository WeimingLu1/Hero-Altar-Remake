...
当前版本通过292项逻辑/视觉单元测试和3项服务端渲染测试，共295项，0失败；标题、存档、模型设置与无障碍流程另在Chromium、Firefox、WebKit各执行7项E2E。项目同时通过类型检查、ESLint、核心源码覆盖率、依赖审计、生产构建与体积预算。项目仍在积极开发中，接口、存档结构和美术资源可能继续调整。
