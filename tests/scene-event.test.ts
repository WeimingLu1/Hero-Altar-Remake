...
const actor=():SceneActorState=>({inventory:{},gold:0,hp:50,maxHp:100,fp:50,maxFp:100,food:0,water:0,exp:0,potential:0,morals:0,tanId:0,teacherId:0,classId:0,gender:0,face:20,mp:0,maxMp:0,age:14,baseBon:20,baseInt:20,baseAgi:20,baseStr:20,bon:20,int:20,agi:20,str:20,luck:20,skills:{},weaponId:0,armorIds:[],skillUse:[0,0,0,0,0,0],fpPlus:0,xue6:false});
